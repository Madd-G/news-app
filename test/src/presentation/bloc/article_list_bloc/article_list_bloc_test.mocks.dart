...
// in news_app/test/src/presentation/bloc/article_list_bloc/article_list_bloc_test.dart.
...
import 'package:news_app/src/domain/entities/article_entity.dart' as _i7;
import 'package:news_app/src/domain/repositories/article_repository.dart'
    as _i2;
import 'package:news_app/src/domain/usecases/get_articles.dart' as _i4;
...
class MockGetArticles extends _i1.Mock implements _i4.GetArticles {
  MockGetArticles() {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.ArticleEntity>>> execute() =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
